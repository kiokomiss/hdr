...
class HDRPlus {
    ...
    public:
		...
		static const int width = 5202; // 3900;//  5202;//5796;
		static const int height = 3465; //  3465; // 3870;
...
const WhiteBalance read_white_balance(std::string file_path) {
    ...
    Tools::Internal::PipeOpener f(("C:/HDR/hdr-plus/tools/dcraw-9.27-ms-32-bit.exe -v -i " + file_path).c_str(), "r");
